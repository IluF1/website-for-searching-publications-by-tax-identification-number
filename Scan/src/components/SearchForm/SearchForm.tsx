...
import { TArticle, TEncodedIdObject, TEncodedIds, TSearchData, TSearchResults } from "../../utils/types/types"
            ...
            <div>
                <div className={s['paragraph-container']}>
                    <div>
                        ...
                        <p className={s.text}>Задайте параметры поиска. <br />
                        ...
                        <form className={s['form-container']}>
                            <div className={s['input-container']}>
                                ...
                                {!innIsValid && !innIsEmpty && isError &&
                                  <span className={s.innError}>неправильный инн</span>}
                                {innIsEmpty && isError && !innIsValid &&
                                  <span className={s.innError}>ошибка</span>}
                            </div>
                            <div className={s['input-container']}>
                    ...
                    <div className={s['checkbox-button-container']}>
                        ...
                        <div className={s['button-container']}>
                            ...
                            {tariffInfo.usedCompanyCount === tariffInfo.companyLimit &&
                              <span className={s.submitError}>ошибка</span>}
